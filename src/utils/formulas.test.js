...
function makeFixture() {
  return [
    // ---- Стройка (9) ----
    {
      ...
      type: "Стройка",
      buff: 0,
      endAt: MOCK_NOW + parseLeft(18, 0, 41),
    ...
    },
    {
      ...
      type: "Стройка",
      buff: 0,
      endAt: MOCK_NOW + parseLeft(15, 4, 43),
      createdAt: MOCK_NOW - 100000,
      applied: 0,
      appliedCount: 0,
      queueReceived: 0,
    ...
    },
    {
      ...
      type: "Стройка",
      buff: 0,
      endAt: MOCK_NOW + parseLeft(25, 10, 57),
      createdAt: MOCK_NOW - 100000,
      applied: 30,
      appliedCount: 2,
      queueReceived: 1,
    ...
    },
    {
      ...
      type: "Стройка",
      buff: 0,
      endAt: MOCK_NOW + parseLeft(22, 9, 14),
      createdAt: MOCK_NOW - 100000,
      applied: 30,
      appliedCount: 2,
      queueReceived: 1,
    ...
    },
    {
      ...
      type: "Стройка",
      buff: 0,
      endAt: MOCK_NOW + parseLeft(21, 5, 42),
      createdAt: MOCK_NOW - 100000,
      applied: 15,
      appliedCount: 1,
      queueReceived: 1,
    ...
    },
    {
      ...
      type: "Стройка",
      buff: 0,
      endAt: MOCK_NOW + parseLeft(12, 10, 52),
      createdAt: MOCK_NOW - 100000,
      applied: 15,
      appliedCount: 1,
      queueReceived: 1,
    ...
    },
    {
      ...
      type: "Стройка",
      buff: 0,
      endAt: MOCK_NOW + parseLeft(10, 19, 6),
      createdAt: MOCK_NOW - 100000,
      applied: 40,
      appliedCount: 3,
      queueReceived: 1,
    ...
    },
    {
      ...
      type: "Стройка",
      buff: 0,
      endAt: MOCK_NOW + parseLeft(9, 10, 7),
      createdAt: MOCK_NOW - 100000,
      applied: 25,
      appliedCount: 2,
      queueReceived: 1,
    ...
    // ---- Исследования (8) ----
    {
      ...
      type: "Исследования",
      buff: 0,
      endAt: MOCK_NOW + parseLeft(12, 7, 57),
      createdAt: MOCK_NOW - 100000,
      applied: 30,
      appliedCount: 2,
      queueReceived: 1,
    ...
    },
    {
      ...
      type: "Исследования",
      buff: 0,
      endAt: MOCK_NOW + parseLeft(11, 21, 16),
      createdAt: MOCK_NOW - 100000,
      applied: 15,
      appliedCount: 1,
      queueReceived: 1,
    ...
    },
    {
      ...
      type: "Исследования",
      buff: 0,
      endAt: MOCK_NOW + parseLeft(9, 21, 4),
      createdAt: MOCK_NOW - 100000,
      applied: 40,
      appliedCount: 3,
      queueReceived: 1,
    ...
    },
    {
      ...
      type: "Исследования",
      buff: 0,
      endAt: MOCK_NOW + parseLeft(9, 13, 15),
      createdAt: MOCK_NOW - 100000,
      applied: 15,
      appliedCount: 1,
      queueReceived: 1,
    ...
    },
    {
      ...
      type: "Исследования",
      buff: 0,
      endAt: MOCK_NOW + parseLeft(9, 1, 22),
      createdAt: MOCK_NOW - 100000,
      applied: 15,
      appliedCount: 1,
      queueReceived: 1,
    ...
    },
    {
      ...
      type: "Исследования",
      buff: 0,
      endAt: MOCK_NOW + parseLeft(8, 3, 8),
      createdAt: MOCK_NOW - 100000,
      applied: 15,
      appliedCount: 1,
      queueReceived: 1,
    ...
    },
    {
      ...
      type: "Исследования",
      buff: 0,
      endAt: MOCK_NOW + parseLeft(6, 19, 40),
      createdAt: MOCK_NOW - 100000,
      applied: 15,
      appliedCount: 1,
      queueReceived: 1,
...
describe("scoreBuff", () => {
  ...
  it("донатер №1 получает множитель ×1.5 к score", () => {
    ...
    expect(score).toBe(24750); // 16500 × 1.5
  });
  ...
  it("донатер №2-3 получает множитель ×1.25", () => {
    ...
    const givers = { Alpha: { total: 10 }, Bravo: { total: 3 }, Charlie: { total: 1 } };
    const { score } = scoreBuff(e, MOCK_NOW, givers);
    expect(score).toBe(20625); // 16500 × 1.25
  });
...
describe("getQueueFireIds", () => {
  ...
  it("🔥 на данных из таблицы: Стройка — Ваша честь и Leaf горят", () => {
    ...
    const fireNicks = all.filter((i) => fires.has(i.id) && i.type === "Стройка").map((i) => i.nick);
  ...
  it("Исследования — никто не горит (все уже получили)", () => {
    ...
    const researchFires = all.filter((i) => i.type === "Исследования" && fires.has(i.id));
